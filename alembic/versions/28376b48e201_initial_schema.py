...
def upgrade() -> None:
    ...
    op.create_index('ix_state_events_aggregate', 'state_events', ['aggregate_type', 'aggregate_id'], unique=False)
    op.create_table('target_revisits',
    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    op.create_table('ui_observations',
    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    op.create_table('attack_intents',
    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    sa.Column('created_at_utc', UTCDateTime(), nullable=False),
    sa.ForeignKeyConstraint(['run_id'], ['run_instances.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('run_id', 'target_galaxy', 'target_system', 'target_position', 'cycle_start_utc', 'forced_revisit', name='uq_attack_intent_run_target_cycle')
    )
    op.create_index(op.f('ix_attack_intents_run_id'), 'attack_intents', ['run_id'], unique=False)
    op.create_table('coordinate_scans',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('run_id', sa.Uuid(), nullable=False),
    sa.Column('galaxy', sa.Integer(), nullable=False),
    sa.Column('system', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_coordinate_scans_run_id'), 'coordinate_scans', ['run_id'], unique=False)
    op.create_table('attack_dispatches',
    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    sa.Column('evidence_artifact_id', sa.Uuid(), nullable=True),
    sa.ForeignKeyConstraint(['intent_id'], ['attack_intents.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('fleet_snapshots',
    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    op.create_index(op.f('ix_fleet_snapshots_report_id'), 'fleet_snapshots', ['report_id'], unique=False)
